...
import { FaBell, FaChartBar, FaMicrophone } from "react-icons/fa6";
  ...
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       ...
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <FaMicrophone className="me-2 fs-5" /> New Announcement </Button>

       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <FaChartBar className="me-2 fs-5" /> New Analytics </Button>

       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <FaBullhorn className="me-2 fs-5" /> View Course Notifications </Button>
